...
wp_enqueue_script('script-js', "https://code.jquery.com/jquery-2.1.1.min.js", array());	
wp_enqueue_script('materializa-js', get_template_directory_uri()."/assets/js/materialize.min.js", array());
wp_enqueue_script( 'material-custom', get_template_directory_uri() . '/assets/js/scripts.js', array(), '1.0', false );
}
